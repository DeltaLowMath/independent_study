...
private:
	...
	// Yaw of the Chracter this frame; Only updated when standing still and not in the air
	float CharacterYaw;

	// Yaw of the Chracter the previous frame; Only updated when standing still and not in the air
	...
	// True when reloading used to prevent Aim Offset
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Turn In Place", meta = (AllowPrivateAccess = "true"))
	bool bReloading;
